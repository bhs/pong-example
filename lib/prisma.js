...
// schema.prisma) as soon as it's constructed. DATABASE_URL is a required
// secret (see .mendel/requirements.json) — there is no placeholder
// fallback here. If it's missing, Prisma Client itself throws as soon as
// this module is required, which is exactly what we want: a container
// with no real database attached should fail loudly at startup rather
// than boot into a server that silently can't do anything useful.
